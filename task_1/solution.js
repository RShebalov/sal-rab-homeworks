...
function addInCartSumChange(sum, delta) {
    ...
    // создаем переменную newSum и присвойте ей сумму oldSum и difference
    let newSum = oldSum + difference;
    // создаем переменную newSumText и присвойте ей результат склеивания переменной newSum и текста ' ₽'
    let newSumText = newSum + ' ₽';
    // заменяем склеивание, используемое в newSum Text , на шаблонную строку
    newSumText = `${newSum} ₽`;
